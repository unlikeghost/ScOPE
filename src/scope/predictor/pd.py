...
from .distances import euclidean, manhattan, squared_euclidean, chebyshev
...
class ScOPEPD(_BasePredictor):
    ...
    def __init__(self, 
        ...
        self.supported_distance_metrics = {
            ...
            "manhattan": lambda x1, x2: manhattan(x1, x2),
            "squared_euclidean": lambda x1, x2: squared_euclidean(x1, x2),
            "chebyshev": lambda x1, x2: chebyshev(x1, x2),
        }
